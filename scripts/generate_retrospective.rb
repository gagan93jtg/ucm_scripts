...
members =  [{name: 'Gagan', username: 'gagandeep.singh', bandwidth: 1, days_worked: 9,
             sheet_key: '1bitkGbG_o5XbmTFD385Yn61d6oM6p8vJcondhh1pFjM'},
            {name: 'Neelakshi', username: 'Neelakshi', bandwidth: 1, days_worked: 10,
             sheet_key: '1iYqA1irBBpktV3ssvxeZRuzkzAZ9RFqYcqI26kJUrSI'},
            {name: 'Dinesh', username: 'DineshYadav', bandwidth: 1, days_worked: 10,
             sheet_key: '1qwx--iJ14ZI9hUgumdixove9aeoQU-oZibKi80QLICQ'},
            {name: 'Sweta', username: 'SwetaSharma', bandwidth: 1, days_worked: 8,
...
ignore_tickets_starting_with = 'TR,TG,MISC,TI,INTERNAL,RETRO,X(Y)'
time_frame = '20170301 - 20170316'
...
retro.get_total_sps = true # As per discussion with Rishu
retro.generate!
